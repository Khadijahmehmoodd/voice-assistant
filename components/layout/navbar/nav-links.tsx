        ...
        <>
          ...
          >
            <div className='relative flex items-center justify-between'>
              ...
              <NavLink
                className='justify-center flex-1 hidden gap-10 lg:flex'
                links={navbarData}
              />
              <div className='flex lg:hidden'>
                <DisclosureButton className='z-50 rounded-md text-canvas-text-contrast'>
                  <IconButton
                    as='div'
                    variant='primary'
                    size='medium'
                    ...
                    icon={
                      open ? (
                        <PiXDuotone
                          aria-hidden='true'
                          className='z-30 flex text-canvas-text-contrast'
                        />
                      ) : (
                        <PiListDuotone
                          aria-hidden='true'
              ...
              <div className='items-center justify-end flex-1 hidden lg:flex'>
                {user ? (
                  <div className='flex items-center gap-1'>
                    ...
                    <button
                      onClick={() => router.push(paths.user.dashboard)}
                    ...
                    >
                      ...
                      <PiUserDuotone className='h-[1.07rem] w-[1.07rem]' />
                    </button>
                  </div>
                ) : (
              ...
              {user ? (
                <div className='gap-3 lg:hidden'>
                  ...
                  <button className='relative hidden px-2 text-sm border rounded-full border-canvas-line focus:outline-none'>
                    ...
                    <span className='sr-only'>Open user menu</span>
                    <Link href={paths.home}>
                      <PiUserDuotone className='w-6 h-6 text-canvas-text' />
                    </Link>
                  </button>
                </div>
              ) : (
                <Link href={paths.user.dashboard} className='flex lg:hidden'>
                  <Button color='primary' variant='solid' size='medium'>
                    Get Started
                  </Button>
                </Link>
